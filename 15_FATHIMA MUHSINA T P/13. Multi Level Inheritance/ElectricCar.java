...
class ElectricCar extends Car 
{
    ...
    public ElectricCar(String registrationNumber, int speed, int fuelCapacity, int numberOfDoors, boolean hasAirConditioning, int batteryCapacity, int chargeLevel) {
