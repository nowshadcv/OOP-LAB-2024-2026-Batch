...
public class MatrixSwitch {
	public  static void main(String[] args) {
		...
		try (Scanner s=new Scanner (System.in)) {
			...
			p=s.nextInt();
			System.out.print("Enter number of columns in matrixA:");
			q=s.nextInt();
			System.out.print("Enter number of rows in matrixB:");
			m=s.nextInt();
			System.out.print("Enter number of columns in matrixB:");
			n=s.nextInt();
			if (p == m && q == n){
				int a[][]=new int[p][q];
				int b[][]=new int[m][n];
