...
public ElectricCar(String reg_no, int speed, int cap, int numberOfDoors, Boolean hasAirConditioning, int
battery, int charge) {
...
electricCars[i] = new ElectricCar(regNo, speed, fuelCapacity, numberOfDoors, hasAirConditioning,
