...
public class StringManipulation {
	public static void main(String[] args) {
		...
		System.out.println(strSample.compareTo("ROCKSTAR")+"/t");
		...
		System.out.println("All small=rock star:"+strSample.toLowerCase());
		...
		System.out.println("nteger value of ival is:"+Integer.valueOf(ival));
